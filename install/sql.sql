...
insert  into `wm_article_type`(`type_id`,`type_status`,`type_topid`,`type_pid`,`type_name`,`type_cname`,`type_pinyin`,`type_order`,`type_ico`,`type_info`,`type_add`,`type_titempid`,`type_tempid`,`type_ctempid`,`type_title`,`type_key`,`type_desc`) values (1,1,0,'0','网站公告','公告','gg',1,'','',0,2,1,3,'','',''),(2,1,0,'0','新闻资讯','新闻','news',2,'','',0,0,0,0,'','','');
...
insert  into `wm_manager_manager`(`manager_id`,`manager_status`,`manager_cid`,`manager_name`,`manager_psw`,`manager_lastip`,`manager_lasttime`) values (1,1,0,'admin','90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad','127.0.0.1',1527389509),(4,1,1,'sdasd','b8dbfcaea467bc655229df4a370cabe063f7daa4','127.0.0.1',1499091969);
